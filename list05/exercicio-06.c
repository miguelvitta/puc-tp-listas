...
int* findIntersection(int* vector1, int size1, int* vector2, int size2, int* size3);

int main() {
    printf(
        "This program receives two vectors of integers and creates a new "
        "vector with the intersection of both vectors.\n");
    ...
    int* vector3 = findIntersection(vector1, size1, vector2, size2, &size3);

    printf("The elements of the intersection are: \n");
