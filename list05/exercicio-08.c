...
int* findDifference(int* vector1, int size1, int* vector2, int size2, int* size3);

int main() {
    printf(
        "This program receives two vectors of integers and creates a new "
        "vector with the elements that are in the first but not in the second vector.\n");
    ...
    int* vector3 = findDifference(vector1, size1, vector2, size2, &size3);

    printf("The elements of the difference are: \n");
